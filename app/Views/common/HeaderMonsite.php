...
<body class="vertical-layout page-header-light vertical-menu-collapsible vertical-gradient-menu preload-transitions 2-columns  app-page " data-open="click" data-menu="vertical-gradient-menu" data-col="2-columns">
    ...
    <ul class="display-none" id="default-search-main">
        ...
        <li class="auto-suggestion"><a class="collection-item" href="#">
                <div class="display-flex">
                    <div class="display-flex align-item-center flex-grow-1">
                        ...
                        <div class="avatar"><img src=" <?php echo base_url('app-assets/images/icon/pdf-image.png') ;?>" width="24" height="30" alt="sample image"></div>
        ...
        <li class="auto-suggestion"><a class="collection-item" href="#">
                <div class="display-flex">
                    <div class="display-flex align-item-center flex-grow-1">
                        <div class="avatar"><img src=" <?php echo base_url('app-assets/images/icon/doc-image.png') ;?>" width="24" height="30" alt="sample image"></div>
        ...
        <li class="auto-suggestion"><a class="collection-item" href="#">
                <div class="display-flex">
                    <div class="display-flex align-item-center flex-grow-1">
                        <div class="avatar"><img src="<?php echo base_url('app-assets/images/icon/xls-image.png') ;?>" width="24" height="30" alt="sample image"></div>
        ...
        <li class="auto-suggestion"><a class="collection-item" href="#">
                <div class="display-flex">
                    <div class="display-flex align-item-center flex-grow-1">
                        <div class="avatar"><img src="   <?php echo base_url('app-assets/images/icon/jpg-image.png') ;?>" width="24" height="30" alt="sample image"></div>
        ...
        <li class="auto-suggestion"><a class="collection-item" href="#">
                <div class="display-flex">
                    <div class="display-flex align-item-center flex-grow-1">
                        <div class="avatar"><img class="circle" src="<?php echo base_url('app-assets/images/avatar/avatar-7.png') ;?>" width="30" alt="sample image"></div>
        ...
        <li class="auto-suggestion"><a class="collection-item" href="#">
                <div class="display-flex">
                    <div class="display-flex align-item-center flex-grow-1">
                        <div class="avatar"><img class="circle" src="  <?php echo base_url('app-assets/images/avatar/avatar-8.png') ;?>" width="30" alt="sample image"></div>
        ...
        <li class="auto-suggestion"><a class="collection-item" href="#">
                <div class="display-flex">
                    <div class="display-flex align-item-center flex-grow-1">
                        <div class="avatar"><img class="circle" src=" <?php echo base_url('app-assets/images/avatar/avatar-10.png') ;?>" width="30" alt="sample image"></div>
        ...
        <li class="auto-suggestion"><a class="collection-item" href="#">
                <div class="display-flex">
                    <div class="display-flex align-item-center flex-grow-1">
                        <div class="avatar"><img class="circle" src=" <?php echo base_url('app-assets/images/avatar/avatar-12.png') ;?>" width="30" alt="sample image"></div>
                        <div class="member-info display-flex flex-column"><span class="black-text">Anna Strong</span><small class="grey-text">Web Designer</small></div>
                    </div>
                </div>
            </a></li>
