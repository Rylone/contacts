...
INSERT INTO `contacts` (`id`, `first_Name`, `last_Name`, `company`, `job`, `email`, `phone`, `note`, `favory`, `createDate`, `image`) VALUES
...
(2, 'Lacota', 'Santana', '065189748-00000', 'Tincidunt Nibh Limited', 'penatibus.et.magnis@pharetranibhAliquam.net', '02 61 05 90 17', 'ut aliquam iaculis, lacus pede sagittis augue, eu tempor erat', 'Yes', '2021-03-23 17:50:18', ''),
...
(50, 'Quail', 'Sanders', '430672097-00002', 'Etiam LLP', 'Sed@odiovelest.edu', '02 47 48 20 69', 'Donec luctus aliquet odio. Etiam ligula tortor, dictum eu, placerat', 'Yes', '2020-10-11 17:58:39', ''),
